package github.alessandrofazio.kafka.consumer.config;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, kafkaConsumerConfigData.getSessionTimoutMs());
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<K,V>> kafkaListenerContainerFactory() {
        ...
        factory.getContainerProperties().setPollTimeout(kafkaConsumerConfigData.getPollTimoutMs());
        return factory;
    }
}
