...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -588816542582137305L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentResponseAvroModel\",\"namespace\":\"github.alessandrofazio.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"sageId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"paymentId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"paymentStatus\",\"type\":{\"type\":\"enum\",\"name\":\"PaymentStatus\",\"symbols\":[\"COMPLETED\",\"CANCELLED\",\"FAILED\"]}},{\"name\":\"failureMessages\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
  ...
  private github.alessandrofazio.kafka.order.avro.model.PaymentStatus paymentStatus;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sageId, java.util.UUID paymentId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, github.alessandrofazio.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sageId = sageId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: paymentStatus = (github.alessandrofazio.kafka.order.avro.model.PaymentStatus)value$; break;
   ...
   */
  public github.alessandrofazio.kafka.order.avro.model.PaymentStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(github.alessandrofazio.kafka.order.avro.model.PaymentStatus value) {
   ...
   */
  public static github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder() {
    return new github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
    if (other == null) {
      return new github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel other) {
    if (other == null) {
      return new github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
    } else {
      return new github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setSageId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearSageId() {
      sageId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentId() {
      paymentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentStatus(github.alessandrofazio.kafka.order.avro.model.PaymentStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentStatus() {
      paymentStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public github.alessandrofazio.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearFailureMessages() {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus : (github.alessandrofazio.kafka.order.avro.model.PaymentStatus) defaultValue(fields()[7]);
