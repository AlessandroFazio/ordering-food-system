...
public class Key extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7879651478604846753L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Key\",\"namespace\":\"debezium.order.restaurant_approval_outbox\",\"fields\":[{\"name\":\"saga_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}}],\"connect.name\":\"debezium.order.restaurant_approval_outbox.Key\"}");
   ...
   */
  public Key(java.lang.String saga_id) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: saga_id = value$ != null ? value$.toString() : null; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static debezium.order.restaurant_approval_outbox.Key.Builder newBuilder() {
    return new debezium.order.restaurant_approval_outbox.Key.Builder();
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static debezium.order.restaurant_approval_outbox.Key.Builder newBuilder(debezium.order.restaurant_approval_outbox.Key.Builder other) {
    if (other == null) {
      return new debezium.order.restaurant_approval_outbox.Key.Builder();
    } else {
      return new debezium.order.restaurant_approval_outbox.Key.Builder(other);
    }
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static debezium.order.restaurant_approval_outbox.Key.Builder newBuilder(debezium.order.restaurant_approval_outbox.Key other) {
    if (other == null) {
      return new debezium.order.restaurant_approval_outbox.Key.Builder();
    } else {
      return new debezium.order.restaurant_approval_outbox.Key.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Key>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(debezium.order.restaurant_approval_outbox.Key.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.saga_id)) {
        this.saga_id = data().deepCopy(fields()[0].schema(), other.saga_id);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(debezium.order.restaurant_approval_outbox.Key other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.saga_id)) {
        this.saga_id = data().deepCopy(fields()[0].schema(), other.saga_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.order.restaurant_approval_outbox.Key.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.order.restaurant_approval_outbox.Key.Builder clearSagaId() {
      saga_id = null;
    ...
    public Key build() {
      try {
        Key record = new Key();
        record.saga_id = fieldSetFlags()[0] ? this.saga_id : (java.lang.String) defaultValue(fields()[0]);
        return record;
