...
public class Key extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1221993283958185386L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Key\",\"namespace\":\"debezium.restaurant.order_outbox\",\"fields\":[{\"name\":\"saga_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}}],\"connect.name\":\"debezium.restaurant.order_outbox.Key\"}");
   ...
   */
  public static debezium.restaurant.order_outbox.Key.Builder newBuilder() {
    return new debezium.restaurant.order_outbox.Key.Builder();
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static debezium.restaurant.order_outbox.Key.Builder newBuilder(debezium.restaurant.order_outbox.Key.Builder other) {
    if (other == null) {
      return new debezium.restaurant.order_outbox.Key.Builder();
    } else {
      return new debezium.restaurant.order_outbox.Key.Builder(other);
    }
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static debezium.restaurant.order_outbox.Key.Builder newBuilder(debezium.restaurant.order_outbox.Key other) {
    if (other == null) {
      return new debezium.restaurant.order_outbox.Key.Builder();
    } else {
      return new debezium.restaurant.order_outbox.Key.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Key>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(debezium.restaurant.order_outbox.Key.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(debezium.restaurant.order_outbox.Key other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.saga_id)) {
        this.saga_id = data().deepCopy(fields()[0].schema(), other.saga_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.restaurant.order_outbox.Key.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.restaurant.order_outbox.Key.Builder clearSagaId() {
      saga_id = null;
