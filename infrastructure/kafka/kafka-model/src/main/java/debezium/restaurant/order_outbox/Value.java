...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -583495834709539015L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"debezium.restaurant.order_outbox\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"saga_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.ZonedTimestamp\"}},{\"name\":\"processed_at\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.ZonedTimestamp\"}},{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"outbox_status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"STARTED,COMPLETED,FAILED\"},\"connect.name\":\"io.debezium.data.Enum\"}},{\"name\":\"order_approval_status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"APPROVED,REJECTED\"},\"connect.name\":\"io.debezium.data.Enum\"}},{\"name\":\"version\",\"type\":\"int\"}],\"connect.name\":\"debezium.restaurant.order_outbox.Value\"}");
  ...
  private java.lang.String order_approval_status;
  private int version;
   ...
   * @param order_approval_status The new value for order_approval_status
   * @param version The new value for version
   */
  public Value(java.lang.String id, java.lang.String saga_id, java.lang.String created_at, java.lang.String processed_at, java.lang.String type, java.lang.String payload, java.lang.String outbox_status, java.lang.String order_approval_status, java.lang.Integer version) {
    this.id = id;
    ...
    this.order_approval_status = order_approval_status;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 7: return order_approval_status;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: order_approval_status = value$ != null ? value$.toString() : null; break;
  ...
  /**
   * Gets the value of the 'order_approval_status' field.
   * @return The value of the 'order_approval_status' field.
   */
  public java.lang.String getOrderApprovalStatus() {
    return order_approval_status;
  }


  /**
   * Sets the value of the 'order_approval_status' field.
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(java.lang.String value) {
    this.order_approval_status = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
    ...
    private Builder(debezium.restaurant.order_outbox.Value.Builder other) {
      ...
      if (isValidValue(fields()[7], other.order_approval_status)) {
        this.order_approval_status = data().deepCopy(fields()[7].schema(), other.order_approval_status);
    ...
    /**
      * Sets the value of the 'order_approval_status' field.
      * @param value The value of 'order_approval_status'.
      * @return This builder.
      */
    public debezium.restaurant.order_outbox.Value.Builder setOrderApprovalStatus(java.lang.String value) {
    ...
    /**
      * Checks whether the 'order_approval_status' field has been set.
      * @return True if the 'order_approval_status' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'order_approval_status' field.
      * @return This builder.
      */
    public debezium.restaurant.order_outbox.Value.Builder clearOrderApprovalStatus() {
      order_approval_status = null;
    ...
    public Value build() {
      try {
        ...
        record.order_approval_status = fieldSetFlags()[7] ? this.order_approval_status : (java.lang.String) defaultValue(fields()[7]);
    ...
    throws java.io.IOException
  {
    ...
    out.writeString(this.order_approval_status);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.order_approval_status = in.readString();
